...
_CLEARDEVICENONCESREQUEST = _descriptor.Descriptor(
  name='ClearDeviceNoncesRequest',
  full_name='api.ClearDeviceNoncesRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='dev_eui', full_name='api.ClearDeviceNoncesRequest.dev_eui', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['ClearDeviceNoncesRequest'] = _CLEARDEVICENONCESREQUEST
...
ClearDeviceNoncesRequest = _reflection.GeneratedProtocolMessageType('ClearDeviceNoncesRequest', (_message.Message,), {
  'DESCRIPTOR' : _CLEARDEVICENONCESREQUEST,
  '__module__' : 'chirpstack_api.as_pb.external.api.device_pb2'
  # @@protoc_insertion_point(class_scope:api.ClearDeviceNoncesRequest)
  })
_sym_db.RegisterMessage(ClearDeviceNoncesRequest)
...
_DEVICESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ClearDeviceNonces',
    full_name='api.DeviceService.ClearDeviceNonces',
    index=16,
    containing_service=None,
    input_type=_CLEARDEVICENONCESREQUEST,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
