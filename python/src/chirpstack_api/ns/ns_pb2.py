...
_CLEARDEVICENONCESREQUEST = _descriptor.Descriptor(
  ...
  full_name='ns.ClearDeviceNoncesRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='dev_eui', full_name='ns.ClearDeviceNoncesRequest.dev_eui', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
ClearDeviceNoncesRequest = _reflection.GeneratedProtocolMessageType('ClearDeviceNoncesRequest', (_message.Message,), {
  ...
  '__module__' : 'chirpstack_api.ns.ns_pb2'
  # @@protoc_insertion_point(class_scope:ns.ClearDeviceNoncesRequest)
  })
...
_NETWORKSERVERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='ns.NetworkServerService.ClearDeviceNonces',
    index=49,
    containing_service=None,
