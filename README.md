...
![Tests](https://github.com/alviso/chirpstack-api/actions/workflows/main.yml/badge.svg?branch=master)
...
Documentation: https://godoc.org/github.com/alviso/chirpstack-api/go

```bash
go get github.com/alviso/chirpstack-api/go/v3
```
...
See the README in /java subfolder: https://github.com/alviso/chirpstack-api/tree/master/java.
